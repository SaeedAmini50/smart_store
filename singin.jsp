        ...
        <div class="container-fluid">
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
					...
					<form action="singinAction.jsp" methed="post">
                       
                        <div class="form-floating mb-3">
                            <input type="email" name="customer_email" class="form-control" id="floatingInput" placeholder="name@example.com">
                            <label for="floatingInput">ایمیل آدرس</label>
                        </div>
                        
                        <div class="form-floating mb-4">
                            <input type="password" name="customer_password" class="form-control" id="floatingPassword" placeholder="Password">
                        ...
                        <button type="submit" value="submit" class="btn btn-primary py-3 w-100 mb-4">Sign In</button>
                        <p class="text-center mb-0">من قبلا حساب درست کردم <a href="signup.jsp">Sign Up</a></p>
                        </form>
                    </div>
                </div>
            </div>
