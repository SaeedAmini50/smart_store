            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-100 bg-secondary rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-6 text-center p-4">
                        ...
                        <h1 class="mb-4">Error Page </h1>
                        <p class="mb-4">We’re sorry, the page you have looked for does not exist in our website!
                            Maybe go to our login page or try to use a login?</p>
                      
                        <a class="btn btn-primary rounded-pill py-3 px-5" href="singin.jsp">Go Back To login Page</a>
                     
                     <br>
                     <br>
                       <a class="btn btn-primary rounded-pill py-3 px-5" href="singup.jsp">Go Back TO Create Accuont Page</a>
